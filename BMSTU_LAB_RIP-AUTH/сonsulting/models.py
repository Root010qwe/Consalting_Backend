...
class ConsultingRequest(models.Model):
    ...
    manager = models.ForeignKey(CustomUser, related_name="managed_requests", on_delete=models.SET_NULL, null=True)
    client = models.ForeignKey(
        CustomUser, on_delete=models.PROTECT, related_name="sender"
    )
    total_cost = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)  # Итоговая стоимость
